				...
				["Unholy"] = {
					...
					["lists"] = {
						...
						["trinkets"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "( ( ! talent.summon_gargoyle.enabled || talent.summon_gargoyle.enabled & pet.gargoyle.active || cooldown.summon_gargoyle.remains > 90 || variable.trinket_priority = 2 & cooldown.summon_gargoyle.remains > 20 ) & ( pet.apoc_ghoul.active || buff.dark_transformation.up ) & ( variable.trinket_priority = 1 || trinket.t2.cooldown.remains ) ) || trinket.t1.buff_duration >= fight_remains",
								["action"] = "trinket1",
								["slot"] = "trinket1",
							}, -- [7]
							{
								["enabled"] = true,
								["criteria"] = "( ( ! talent.summon_gargoyle.enabled || talent.summon_gargoyle.enabled & pet.gargoyle.active || cooldown.summon_gargoyle.remains > 90 || variable.trinket_priority = 1 & cooldown.summon_gargoyle.remains > 20 ) & ( pet.apoc_ghoul.active || buff.dark_transformation.up ) & ( variable.trinket_priority = 2 || trinket.t1.cooldown.remains ) ) || trinket.t2.buff_duration >= fight_remains",
								["action"] = "trinket2",
								["slot"] = "trinket2",
							}, -- [8]
							{
								["enabled"] = true,
								["criteria"] = "! variable.trinket_1_buffs & ( trinket.t2.cooldown.remains || ! variable.trinket_2_buffs || ! talent.summon_gargoyle.enabled || cooldown.summon_gargoyle.remains > 20 & ! pet.gargoyle.active ) || fight_remains < 15",
								["action"] = "trinket1",
								["slot"] = "trinket1",
							}, -- [9]
							{
								["enabled"] = true,
								["criteria"] = "! variable.trinket_2_buffs & ( trinket.t1.cooldown.remains || ! variable.trinket_1_buffs || ! talent.summon_gargoyle.enabled || cooldown.summon_gargoyle.remains > 20 & ! pet.gargoyle.active ) || fight_remains < 15",
								["action"] = "trinket2",
								["slot"] = "trinket2",
							}, -- [10]
						},
