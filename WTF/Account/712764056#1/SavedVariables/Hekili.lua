					...
					["lists"] = {
						...
						["precombat"] = {
							...
							}, -- [5]
							{
								...
								["op"] = "set",
								["action"] = "variable",
								["value"] = "main_hand.two_hand & talent.might_of_the_frozen_wastes.enabled",
						...
						["cooldowns"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "talent.obliteration.enabled & ! buff.empower_rune_weapon.up & rune < 6 & ( cooldown.pillar_of_frost.remains < 7 & ( variable.adds_remain || variable.st_planning ) || buff.pillar_of_frost.up ) || fight_remains < 20",
						...
						["trinkets"] = {
							...
							}, -- [3]
							{
								...
								["action"] = "trinket1",
								["slot"] = "trinket1",
								["criteria"] = "( ! trinket.t1.has_use_buff & ( trinket.t2.cooldown.remains || ! trinket.t2.has_use_buff ) || talent.pillar_of_frost.enabled & cooldown.pillar_of_frost.remains > 20 || ! talent.pillar_of_frost.enabled )",
							...
							}, -- [4]
							{
								["enabled"] = true,
								["action"] = "trinket2",
								["criteria"] = "( ! trinket.t2.has_use_buff & ( trinket.t1.cooldown.remains || ! trinket.t1.has_use_buff ) || talent.pillar_of_frost.enabled & cooldown.pillar_of_frost.remains > 20 || ! talent.pillar_of_frost.enabled )",
								["slot"] = "trinket2",
							}, -- [5]
						},
						["default"] = {
				...
				["Unholy"] = {
					...
					["lists"] = {
						["default"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "talent.commander_of_the_dead.enabled & ( cooldown.dark_transformation.remains < 4 || buff.commander_of_the_dead_window.up ) || ! talent.commander_of_the_dead.enabled & talent.unholy_assault.enabled & cooldown.unholy_assault.remains < 10 || ! talent.unholy_assault.enabled & ! talent.commander_of_the_dead.enabled || fight_remains <= 30",
						...
						["generic"] = {
							{
								["enabled"] = true,
								["criteria"] = "! variable.pooling_runic_power & ( rune < 3 || pet.gargoyle.active || buff.sudden_doom.react )",
								["action"] = "death_coil",
							}, -- [1]
							{
								["enabled"] = true,
								["criteria"] = "! death_and_decay.ticking & ( active_enemies >= 2 & death_knight.fwounded_targets >= cycle_enemies || covenant.night_fae & ( ! talent.apocalypse.enabled || debuff.festering_wound.stack >= 4 & ( cooldown.apocalypse.remains < gcd.max || cooldown.apocalypse.remains > time_to_max_charges ) ) || runeforge.phearomones.enabled )",
								["action"] = "any_dnd",
							}, -- [2]
							{
								["enabled"] = true,
						...
						["covenants"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "variable.st_planning & ! soulbind.lead_by_example.enabled & ( cooldown.apocalypse.remains || ! talent.army_of_the_damned.enabled & cooldown.dark_transformation.remains ) & rune.time_to_4 > buff.runic_corruption.remains || fight_remains < 12 + ( soulbind.kevins_oozeling.enabled * 28 )",
								["action"] = "abomination_limb",
							}, -- [3]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "variable.st_planning & ( cooldown.apocalypse.remains > 10 || ! talent.army_of_the_damned.enabled & cooldown.dark_transformation.remains ) || fight_remains < 15",
								["action"] = "shackle_the_unworthy",
							}, -- [7]
							{
								["enabled"] = true,
						...
						["aoe"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "rune = 0 & variable.adds_remain",
								["action"] = "abomination_limb",
							}, -- [2]
							{
								["enabled"] = true,
								["action"] = "apocalypse",
								["criteria"] = "debuff.festering_wound.stack >= 4 & variable.adds_remain & ! death_and_decay.ticking & cooldown.death_and_decay.remains & rune < 3 || death_and_decay.ticking & rune = 0",
								["cycle_targets"] = 1,
							}, -- [3]
							{
								["enabled"] = true,
							...
							}, -- [8]
							{
								["enabled"] = true,
								["action"] = "wound_spender",
								["criteria"] = "cooldown.death_and_decay.remains > 10",
								["cycle_targets"] = 1,
							}, -- [9]
						},
						["trinkets"] = {
							...
							}, -- [4]
							{
								["enabled"] = true,
								["action"] = "trinket1",
								["criteria"] = "( ( ! talent.summon_gargoyle.enabled || talent.summon_gargoyle.enabled & pet.gargoyle.active || cooldown.summon_gargoyle.remains > 90 ) & ( pet.apoc_ghoul.active || buff.dark_transformation.up ) & variable.trinket_priority = 1 ) || trinket.t1.buff_duration >= fight_remains",
								["slot"] = "trinket1",
							}, -- [5]
							{
								["enabled"] = true,
								["action"] = "trinket2",
								["criteria"] = "( ( ! talent.summon_gargoyle.enabled || talent.summon_gargoyle.enabled & pet.gargoyle.active || cooldown.summon_gargoyle.remains > 90 ) & ( pet.apoc_ghoul.active || buff.dark_transformation.up ) & variable.trinket_priority = 2 ) || trinket.t2.buff_duration >= fight_remains",
								["slot"] = "trinket2",
							}, -- [6]
							{
								["enabled"] = true,
								["action"] = "trinket1",
								["criteria"] = "! trinket.t1.has_use_buff & ( trinket.t2.cooldown.remains || ! trinket.t2.has_use_buff || ! talent.summon_gargoyle.enabled || cooldown.summon_gargoyle.remains > 20 & ! pet.gargoyle.active ) || fight_remains < 15",
								["slot"] = "trinket1",
							}, -- [7]
							{
								["enabled"] = true,
								["action"] = "trinket2",
								["criteria"] = "! trinket.t2.has_use_buff & ( trinket.t1.cooldown.remains || ! trinket.t1.has_use_buff || ! talent.summon_gargoyle.enabled || cooldown.summon_gargoyle.remains > 20 & ! pet.gargoyle.active ) || fight_remains < 15",
								["slot"] = "trinket2",
							}, -- [8]
						},
						["cooldowns"] = {
							{
								["enabled"] = true,
								["criteria"] = "( 30 >= pet.gargoyle.remains & pet.gargoyle.active ) || ( ! talent.summon_gargoyle.enabled || cooldown.summon_gargoyle.remains > 60 ) & ( buff.dark_transformation.up & 30 >= buff.dark_transformation.remains || pet.army_ghoul.active & pet.army_ghoul.remains <= 30 || pet.apoc_ghoul.active & pet.apoc_ghoul.remains <= 30 ) || fight_remains <= 30",
								["action"] = "potion",
							}, -- [1]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "variable.st_planning & ( ! talent.apocalypse.enabled || debuff.festering_wound.stack >= 4 & cooldown.apocalypse.remains < gcd.max )",
								["action"] = "dark_transformation",
							}, -- [8]
							{
								["enabled"] = true,
								["criteria"] = "variable.adds_remain & ( cooldown.any_dnd.remains < 10 & talent.infected_claws.enabled & ( ( cooldown.vile_contagion.remains || raid_event.adds.exists & raid_event.adds.in > 10 ) & death_knight.fwounded_targets < cycle_enemies || ! talent.vile_contagion.enabled ) & ( raid_event.adds.remains > 5 || ! raid_event.adds.exists ) || ! talent.infected_claws.enabled ) || fight_remains < 25",
								["action"] = "dark_transformation",
							}, -- [9]
							{
								["enabled"] = true,
								["action"] = "apocalypse",
								["criteria"] = "debuff.festering_wound.stack > 3 & active_enemies <= 3 & ( ! talent.commander_of_the_dead.enabled || talent.commander_of_the_dead.enabled & buff.commander_of_the_dead_window.up )",
								["cycle_targets"] = 1,
							}, -- [10]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "variable.adds_remain || fight_remains < 21",
								["action"] = "unholy_blight",
							}, -- [14]
							{
								["enabled"] = true,
								["criteria"] = "variable.st_planning & rune < 3",
								["action"] = "abomination_limb",
							}, -- [15]
							{
								["enabled"] = true,
								["criteria"] = "active_enemies >= 2 & ! buff.dark_transformation.up & cooldown.dark_transformation.remains > 6 || fight_remains < gcd.max",
								["action"] = "sacrificial_pact",
							}, -- [16]
						},
						["racials"] = {
				...
				["Blood"] = {
					...
					["lists"] = {
						["drw_up"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "( buff.bone_shield.remains <= rune.time_to_3 || ( buff.bone_shield.stack < 2 & buff.abomination_limb.up ) ) & runic_power.deficit > 20",
								["action"] = "marrowrend",
							}, -- [3]
							{
								["enabled"] = true,
								["criteria"] = "buff.bone_shield.remains <= rune.time_to_3 & rune <= 1",
							...
							{
								["enabled"] = true,
								["criteria"] = "( ( charges >= 2 & rune <= 1 ) || dot.blood_plague.remains <= 2 ) || ( spell_targets.blood_boil > 5 & charges_fractional >= 1.1 )",
								["action"] = "blood_boil",
							}, -- [10]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "runic_power.deficit <= variable.heart_strike_rp_drw",
								["action"] = "death_strike",
							}, -- [12]
							{
								["action"] = "consumption",
							...
							{
								["enabled"] = true,
								["criteria"] = "! death_and_decay.ticking & ( ( spell_targets.death_and_decay > 2 & buff.crimson_scourge.up ) || spell_targets.death_and_decay >= 4 )",
								["action"] = "death_and_decay",
							}, -- [14]
							{
								["enabled"] = true,
						...
						["default"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "! buff.dancing_rune_weapon.up & ( pet.ghoul.remains < 2 || fight_remains < gcd.max )",
								["action"] = "sacrificial_pact",
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.bone_shield.remains < gcd.max",
								["action"] = "marrowrend",
							}, -- [13]
							{
								["enabled"] = true,
								["criteria"] = "buff.bone_shield.remains < gcd.max || ! buff.bone_shield.up",
								["action"] = "deaths_caress",
							}, -- [14]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "! death_and_decay.ticking & ( talent.unholy_ground.enabled || talent.sanguine_ground.enabled ) & cooldown.dancing_rune_weapon.remains < gcd.max",
								["action"] = "death_and_decay",
							}, -- [17]
							{
								["enabled"] = true,
						...
						["standard"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.bone_shield.stack < 6",
								["action"] = "abomination_limb",
								["description"] = "Consider adding empower_rune_weapon here, but as it looks, DRW may end up aligning every 2nd drw",
							}, -- [2]
							{
								["enabled"] = true,
								["criteria"] = "buff.bone_shield.remains <= rune.time_to_3 || buff.bone_shield.remains <= ( gcd.max + cooldown.blooddrinker.ready * talent.blooddrinker.enabled * 4 ) || buff.bone_shield.stack < 6 & runic_power.deficit > 20 & ! ( talent.insatiable_blade.enabled & cooldown.dancing_rune_weapon.remains < buff.bone_shield.remains )",
								["action"] = "marrowrend",
							}, -- [3]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "runic_power.deficit <= variable.death_strike_dump_amount & ! ( talent.bonestorm.enabled & cooldown.bonestorm.remains < 2 )",
								["action"] = "death_strike",
							}, -- [11]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "! death_and_decay.ticking & buff.crimson_scourge.up & talent.relish_in_blood.enabled & runic_power.deficit > 10",
								["action"] = "death_and_decay",
							}, -- [13]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "( runic_power.deficit <= variable.heart_strike_rp ) || fight_remains < 10",
								["action"] = "death_strike",
							}, -- [15]
							{
								["enabled"] = true,
								["criteria"] = "! death_and_decay.ticking & spell_targets.death_and_decay >= 3",
								["action"] = "death_and_decay",
							}, -- [16]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "! death_and_decay.ticking & ( buff.crimson_scourge.up || talent.rapid_decomposition.enabled )",
								["action"] = "death_and_decay",
							}, -- [19]
							{
								["enabled"] = true,
					...
					["version"] = 20221105,
					["warnings"] = "The import for 'drw_up' required some automated changes.\nLine 1: Converted 'runeforge.crimson_rune_weapon' to 'runeforge.crimson_rune_weapon.enabled' (1x).\nLine 9: Converted 'talent.sanguine_ground' to 'talent.sanguine_ground.enabled' (1x).\nLine 9: Converted 'talent.unholy_ground' to 'talent.unholy_ground.enabled' (1x).\n\nThe import for 'default' required some automated changes.\nLine 17: Converted 'talent.unholy_ground' to 'talent.unholy_ground.enabled' (1x).\nLine 17: Converted 'talent.sanguine_ground' to 'talent.sanguine_ground.enabled' (1x).\n\nThe import for 'standard' required some automated changes.\nLine 3: Converted 'talent.insatiable_blade' to 'talent.insatiable_blade.enabled' (1x).\nLine 7: Converted 'talent.sanguine_ground' to 'talent.sanguine_ground.enabled' (1x).\nLine 7: Converted 'talent.unholy_ground' to 'talent.unholy_ground.enabled' (1x).\n\nThe import for 'covenants' required some automated changes.\nLine 3: Converted 'soulbind.pustule_eruption' to 'soulbind.pustule_eruption.enabled' (1x).\nLine 3: Converted 'soulbind.volatile_solvent' to 'soulbind.volatile_solvent.enabled' (1x).\n\nImported 6 action lists.\n",
