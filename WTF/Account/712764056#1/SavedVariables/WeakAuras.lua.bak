...
WeakAurasSaved = {
	...
	["displays"] = {
		...
		["10.0稀有击杀监控"] = {
			...
			["wagoID"] = "9o2DUdr9t",
			["xOffset"] = -911.9447021484375,
			["preferToUpdate"] = false,
			["yOffset"] = -259.8055114746094,
			["gridType"] = "RD",
		...
		["SR稀有"] = {
			...
			["sparkRotation"] = 0,
			["sameTexture"] = true,
			["url"] = "https://wago.io/9o2DUdr9t/18",
			["actions"] = {
				["start"] = {
				},
				["init"] = {
					["custom"] = "aura_env.zones = {\n    {\n        zoneId = 2022, \n        zone = \"觉醒海岸\",\n    },\n    {\n        zoneId = 2023, \n        zone = \"欧恩哈拉平原\"\n    },\n    {\n        zoneId = 2024, \n        zone = \"碧蓝林海\"\n    },\n    {\n        zoneId = 2025, \n        zone = \"索德拉苏斯\"\n    }\n}",
					["do_custom"] = true,
				},
				["finish"] = {
				},
			...
			["config"] = {
				["rares"] = {
					{
						...
						["drops"] = "皮甲胸, 板甲腿, 项链, 敏捷匕首, 锁甲头, 布甲鞋, 皮甲肩, 战刃, 饰品",
						["alwaysDisplay"] = true,
						["isElite"] = true,
					}, -- [1]
					{
					...
					}, -- [2]
					{
						...
						["drops"] = "披风, 皮甲鞋, 智力法杖, 板甲肩, 锁甲肩, 锁甲胸, 战刃, 板甲腿, 饰品",
						["alwaysDisplay"] = true,
						["isElite"] = true,
					}, -- [3]
					{
						["zone"] = 1,
						["name"] = "[精英] 战角皮尔胡斯(28,59)",
						["hiddenQuestId"] = "74040",
						["classDisplay"] = {
							false, -- [1]
							false, -- [2]
						...
						["drops"] = "项链, 饰品, 枪, 敏捷匕首, 敏捷拳套, 智力单手锤, 皮甲胸, 皮甲肩, 戒指, 战刃,锁甲头, 板甲腿, 布甲鞋",
						["alwaysDisplay"] = true,
						["isElite"] = true,
					}, -- [4]
					{
						...
						["drops"] = "智力法杖, 皮甲鞋, 板甲肩, 锁甲肩, 锁甲胸, 板甲腿, 饰品",
						["alwaysDisplay"] = true,
						["isElite"] = true,
					}, -- [5]
					{
						...
						["drops"] = "板甲胸, 敏捷单手剑, 智力法杖, 敏捷长柄",
						["alwaysDisplay"] = true,
						["isElite"] = true,
					}, -- [6]
					{
						["zone"] = 3,
						["name"] = "[精英] 高阶萨满祭司腐指(16,33)",
						["hiddenQuestId"] = "74004",
						["classDisplay"] = {
							false, -- [1]
							false, -- [2]
					...
					}, -- [7]
					{
						...
						["drops"] = "力量长柄, 力量单手锤, 板甲头",
						["alwaysDisplay"] = true,
						["isElite"] = true,
					}, -- [8]
					{
						["zone"] = 1,
						["name"] = "[精英] 坩埚搬运者布拉科尔(26,58)",
						["hiddenQuestId"] = "74042",
						["classDisplay"] = {
							false, -- [1]
							false, -- [2]
					...
					{
						["hiddenQuestId"] = "73072",
						["name"] = "[精英]贪食的恩凯尼(22,65)",
						["drops"] = "单手斧（力量），戒指，拳套（敏捷），饰品",
						["classDisplay"] = {
							false, -- [1]
							false, -- [2]
							false, -- [3]
				...
				["general"] = {
					["onlyElites"] = false,
					["hideWeekliesOutsideZone"] = true,
					["hideRaresOutsideZone"] = true,
					["showWeekly"] = true,
					["hideCompleted"] = false,
				},
				["weeklies"] = {
		...
		["蕨皮F4"] = {
			...
			["triggers"] = {
				{
					["trigger"] = {
						...
						["subeventPrefix"] = "SPELL",
						["unit"] = "player",
						["custom"] = "function(allstates, event, timestamp, subEvent, _, _, _, _, _, destGUID, destName, _, _, ...)\n    if not aura_env.last or aura_env.last < GetTime() - aura_env.config[\"throttleRefresh\"] then\n        aura_env.last = GetTime()\n        local rareID, prevRareID, gnarlsTime, rotTime, snarTime, blisTime = aura_env.GetSpawn()\n        local nextRareName, prevRareName, nextRareTime\n        local gnarlsName, rotName, snarName, blisName\n        local questID\n        \n        for _, v in pairs(aura_env.rareList) do\n            if aura_env.config[\"simpleMode\"] then\n                if v[\"rareOrder\"] == rareID then\n                    questID = v[\"qid\"] \n                    nextRareName = v[aura_env.lang]\n                elseif v[\"rareOrder\"] == prevRareID then\n                    prevRareName = v[aura_env.lang]\n                end\n            else\n                if v[\"rareOrder\"] == 1 then\n                    gnarlsName = v[aura_env.lang]\n                elseif v[\"rareOrder\"] == 2 then\n                    rotName = v[aura_env.lang]\n                elseif v[\"rareOrder\"] == 3 then\n                    snarName = v[aura_env.lang]\n                elseif v[\"rareOrder\"] == 4 then\n                    blisName = v[aura_env.lang]\n                end\n            end\n        end\n        \n        if rareID == 1 then\n            nextRareTime = gnarlsTime\n        elseif rareID == 2 then\n            nextRareTime = rotTime\n        elseif rareID == 3 then\n            nextRareTime = snarTime\n        elseif rareID == 4 then\n            nextRareTime = blisTime\n        end\n        \n        if aura_env.config[\"simpleMode\"] then\n            allstates[1] = {\n                show = true,\n                changed = true,\n                autoHide = true,\n                progressType = \"timed\",\n                expirationTime = nextRareTime,\n                duration = 600,\n                nextRare = nextRareName,\n                killed = aura_env.hasRareCompleted(questID)\n            }\n        else \n            allstates[1] = {\n                show = true,\n                changed = true,\n                autoHide = true,\n                progressType = \"timed\",\n                expirationTime = gnarlsTime,\n                duration = 2400,\n                nextRare = gnarlsName,\n                killed = aura_env.hasRareCompleted(aura_env.rareList[197354][\"qid\"])\n            }\n            allstates[2] = {\n                show = true,\n                changed = true,\n                autoHide = true,\n                progressType = \"timed\",\n                expirationTime = rotTime,\n                duration = 2400,\n                nextRare = rotName,\n                killed = aura_env.hasRareCompleted(aura_env.rareList[197356][\"qid\"])\n            }\n            allstates[3] = {\n                show = true,\n                changed = true,\n                autoHide = true,\n                progressType = \"timed\",\n                expirationTime = snarTime,\n                duration = 2400,\n                nextRare = snarName,\n                killed = aura_env.hasRareCompleted(aura_env.rareList[197344][\"qid\"])\n            }\n            allstates[4] = {\n                show = true,\n                changed = true,\n                autoHide = true,\n                progressType = \"timed\",\n                expirationTime = blisTime,\n                duration = 2400,\n                nextRare = blisName,\n                killed = aura_env.hasRareCompleted(aura_env.rareList[197353][\"qid\"])\n            }\n        end\n    end\n    return true\nend",
						["spellIds"] = {
						},
						["events"] = "CLEU",
						["check"] = "event",
			...
			["actions"] = {
				...
				["init"] = {
					["custom"] = "aura_env.hasRareCompleted = function(questID)\n    return C_QuestLog.IsQuestFlaggedCompleted(questID)\nend\n\naura_env.lang = GetLocale()\n\naura_env.rareList = {\n    [197354] = {\n        enUS = \"Gnarls\",\n        deDE = \"Knorren\",\n        frFR = \"Grognarde\",\n        enGB = \"Gnarls\",\n        itIT = \"Ceppos\",\n        KoKR = \"[Gnarls]\",\n        zhTW = \"纳亚尔斯\",\n        zhCN = \"纳亚尔斯\",\n        ruRU = \"Дупляк\",\n        esES = \"Gnarls\",\n        esMX = \"Gnarls\",\n        ptBR = \"Nodosus\",\n        rareOrder = 1,\n        qid = 73996\n    },\n    [197356] = {\n        enUS = \"High Shaman Rotknuckle\",\n        deDE = \"Hochschamanin Faulknöchel\",\n        frFR = \"Grand chaman Rance-Jarret\",\n        enGB = \"High Shaman Rotknuckle\",\n        itIT = \"Gran Sciamano Noccamarcia\",\n        KoKR = \"[High Shaman Rotknuckle]\",\n        zhTW = \"高阶萨满祭司腐指\",\n        zhCN = \"高阶萨满祭司腐指\",\n        ruRU = \"Верховный шаман Гнилапа\",\n        esES = \"Alta chamán Putrenudillo\",\n        esMX = \"Alta chamán Putrenudillo\",\n        ptBR = \"Suma Xamã Juntapodre\",\n        rareOrder = 2,\n        qid = 74004\n    },\n    [197344] = {\n        enUS = \"Snarglebone\",\n        deDE = \"Nuschelknochen\",\n        frFR = \"Snarglos\",\n        enGB = \"Snarglebone\",\n        itIT = \"Trinciaossa\",\n        KoKR = \"[Snarglebone]\",\n        zhTW = \"斯纳格伯恩\",\n        zhCN = \"斯纳格伯恩\",\n        ruRU = \"Кривокост\",\n        esES = \"Refrenahuesos\",\n        esMX = \"Refrenahuesos\",\n        ptBR = \"Bramosso\",\n        rareOrder = 3,\n        qid = 74032\n    },\n    [197353] = {\n        enUS = \"Blisterhide\",\n        deDE = \"Blasenfell\",\n        frFR = \"Pelchancre\",\n        enGB = \"Blisterhide\",\n        itIT = \"Pustomanto\",\n        KoKR = \"[Blisterhide]\",\n        zhTW = \"疱革\",\n        zhCN = \"疱革\",\n        ruRU = \"Язвошкур\",\n        esES = \"Ampollacuero\",\n        esMX = \"Ampollacuero\",\n        ptBR = \"Pustuloso\",\n        rareOrder = 4,\n        qid = 73985\n    }\n}\n\nfunction aura_env.GetSpawn()\n    local adjustment = aura_env.config[\"adjustSeconds\"]\n    local rareID, prevRareID\n    local gnarlsTime, rotTime, snarTime, blisTime\n    local hours, minutes, seconds = date(\"%H\"), date(\"%M\"), date(\"%S\")\n    local fullMins = (minutes:sub(1,1)+1)*10\n    \n    if hours % 2 == 0 then\n        if fullMins == 40 then\n            rareID = 1            \n        elseif fullMins == 10 or fullMins == 50 then\n            rareID = 2\n        elseif fullMins == 20 or fullMins == 60 then\n            rareID = 3\n        elseif fullMins == 30 then\n            rareID = 4\n        end\n    else\n        if fullMins == 40 then\n            rareID = 3            \n        elseif fullMins == 10 or fullMins == 50 then\n            rareID = 4\n        elseif fullMins == 20 or fullMins == 60 then\n            rareID = 1\n        elseif fullMins == 30 then\n            rareID = 2\n        end\n    end\n    \n    if rareID == 1 then\n        prevRareID = 4\n    else\n        prevRareID = rareID-1\n    end\n    \n    local timeInSeconds = GetTime()+(((minutes - fullMins)*-1-1)*60 + (seconds-60)*-1 + adjustment)\n    local orderFirst = timeInSeconds\n    local orderSecond = timeInSeconds + 600\n    local orderThird = timeInSeconds + 1200\n    local orderFourth = timeInSeconds + 1800\n    \n    if rareID == 1 then\n        gnarlsTime = orderFirst\n        rotTime = orderSecond\n        snarTime = orderThird\n        blisTime = orderFourth\n    elseif rareID == 2 then\n        rotTime = orderFirst\n        snarTime = orderSecond\n        blisTime = orderThird\n        gnarlsTime = orderFourth\n    elseif rareID == 3 then\n        snarTime = orderFirst\n        blisTime = orderSecond\n        gnarlsTime = orderThird\n        rotTime = orderFourth\n    elseif rareID == 4 then\n        blisTime = orderFirst\n        gnarlsTime = orderSecond\n        rotTime = orderThird\n        snarTime = orderFourth\n    end\n    \n    return rareID, prevRareID, gnarlsTime, rotTime, snarTime, blisTime\nend",
					["do_custom"] = true,
				},
				["finish"] = {
				},
			...
			["authorOptions"] = {
				{
					["type"] = "toggle",
					["default"] = true,
					["desc"] = "Shows only next timer when active",
					["key"] = "simpleMode",
					["useDesc"] = true,
					["name"] = "Simple Mode",
					["width"] = 1,
				}, -- [1]
				{
					...
					["min"] = -6000,
					["key"] = "adjustSeconds",
					["desc"] = "Changes the timer in Seconds",
					["name"] = "Adjustment Seconds",
					["default"] = 0,
				}, -- [2]
				{
					["type"] = "range",
					...
					["min"] = 0.1,
					["key"] = "throttleRefresh",
					["desc"] = "If this Aura is using too much Power adjust this Setting",
			...
			["conditions"] = {
				...
				}, -- [1]
				{
					["check"] = {
						...
						["value"] = "function()\n    return aura_env.config[\"simpleMode\"]\nend",
					},
					["changes"] = {
						{
							["value"] = true,
		...
		["社区盛宴"] = {
			...
			["authorOptions"] = {
				{
					["type"] = "toggle",
					["default"] = false,
					["key"] = "disableOnCompletion",
					["useDesc"] = false,
					["name"] = "Disable after weekly completed",
					["width"] = 2,
				}, -- [1]
				{
					["type"] = "toggle",
					["default"] = true,
					["desc"] = "you will hear \"airhorn\"",
					["key"] = "sound",
					["useDesc"] = true,
					["name"] = "Play sound 3 minutes before it starts",
					["width"] = 2,
				}, -- [2]
			},
			["preferToUpdate"] = false,
			["customText"] = "function()\n    if aura_env.nextFeastIn > 11700 then\n        return \"社区盛宴进行中\"    \n    end\n    \n    return \"社区盛宴准备中\"\nend",
			["yOffset"] = 0,
			["anchorPoint"] = "CENTER",
			["sparkRotation"] = 0,
			["sparkRotationMode"] = "AUTO",
			["url"] = "https://wago.io/rPYC1wHWD/1",
			["icon"] = false,
			["triggers"] = {
				{
					["trigger"] = {
			...
			["actions"] = {
				...
				["init"] = {
					["custom"] = "aura_env.lastCheck = 0\naura_env.nextFeastIn = 0\naura_env.eventEndAt = 3*60*60+15*60\n\naura_env.hasWeeklyCompleted = function()\n    return C_QuestLog.IsQuestFlaggedCompleted(70893)\nend\n\naura_env.disabled = aura_env.config.disableOnCompletion and aura_env.hasWeeklyCompleted()\n\nlocal nextDayMap = {\n    [\"星期一\"] = \"星期二\", \n    [\"星期二\"] = \"星期三\", \n    [\"星期三\"] = \"星期四\", \n    [\"星期四\"] = \"星期五\",\n    [\"星期五\"] = \"星期六\", \n    [\"星期六\"] = \"星期日\",    \n    [\"星期日\"] = \"星期一\",\n}\n\nlocal dayMap = {\n    \"星期日\",\n    \"星期一\",\n    \"星期二\",\n    \"星期三\",\n    \"星期四\",\n    \"星期五\",\n    \"星期六\"\n}\n\nlocal weekdayTimesMap = {\n    [\"星期一\"] = {\n        \"01:30\",\n        \"05:00\",\n        \"08:30\",\n        \"12:00\",\n        \"15:30\",\n        \"19:00\",\n        \"22:30\",           \n    },\n    [\"星期二\"] = {\n        \"02:00\",\n        \"05:30\",\n        \"09:00\", \n        \"12:30\", \n        \"16:00\",\n        \"19:30\",        \n        \"23:00\"\n    },\n    [\"星期三\"]= {\n        \"02:30\",\n        \"06:00\",\n        \"09:30\",\n        \"13:00\",\n        \"16:30\",\n        \"20:00\",\n        \"23:30\",\n    },\n    [\"星期四\"] = {\n        \"03:00\",\n        \"06:30\",\n        \"10:00\",\n        \"13:30\",           \n        \"17:00\",\n        \"20:30\",\n    },\n    [\"星期五\"] = {\n        \"00:00\",\n        \"03:30\",\n        \"07:00\",\n        \"10:30\",\n        \"14.00\",\n        \"17:30\",\n        \"21:00\"\n    },\n    [\"星期六\"] = {\n        \"00:30\",\n        \"04:00\",\n        \"07:30\",\n        \"11:00\",\n        \"14:30\",\n        \"18:00\",\n        \"21:30\"\n    },\n    [\"星期日\"] = {\n        \"01:00\",\n        \"04:30\",\n        \"08:00\",\n        \"11:30\",\n        \"15:00\",\n        \"18:30\",\n        \"22:00\",\n    }\n}\n\naura_env.transformIndexToWeekday = function(index)\n    return dayMap[index]    \nend\n\naura_env.getNextDay = function(day)\n    return nextDayMap[day]\nend\n\naura_env.findTimesForDay = function(day)\n    return weekdayTimesMap[day]\nend\n\naura_env.findNextEventForTime = function(times, hours, minutes)\n    for i = 1, #times, 1 do\n        local hour = tonumber(string.sub(times[i], 1, 2))\n        local minute = tonumber(string.sub(times[i], 4, 5))      \n        \n        if hour > hours or (hour == hours and minutes < minute) then\n            return hour, minute \n        end\n    end\nend\n\nlocal function getRemainingSecondsOfDay(hours, minutes)\n    return 86400 - hours * 60 * 60 - minutes * 60\nend\n\naura_env.calcSecondsUntil = function(hours, minutes, eventStartHours, eventStartMinutes)\n    -- eg 22:30 -> 1:30\n    if hours > eventStartHours then               \n        return getRemainingSecondsOfDay(hours, minutes) + eventStartHours * 60 * 60 + eventStartMinutes * 60    \n    end\n    \n    -- eg 22:07 -> 22:30\n    if hours == eventStartHours then        \n        return (eventStartMinutes - minutes) * 60\n    end\n    \n    -- eg 21:07 -> 22:30\n    local hoursDiff = eventStartHours - hours\n    local minutesDiff = eventStartMinutes - minutes\n    \n    return hoursDiff * 60 * 60 + minutesDiff * 60 \nend\n\n\n\n\n",
					["do_custom"] = true,
				},
				["finish"] = {
				},
			...
			["conditions"] = {
				...
				}, -- [2]
				{
					["check"] = {
						["trigger"] = -1,
						["variable"] = "customcheck",
						["value"] = "function()\n    return aura_env.config.sound and aura_env.nextFeastIn <= 300\nend",
					},
					["changes"] = {
						{
							["value"] = {
		...
		["围攻灭龙要塞"] = {
			...
			["xOffset"] = 0,
			["preferToUpdate"] = false,
			["customText"] = "function()\n    if aura_env.nextFeastIn > 3600 then\n        return \"灭龙要塞围攻中\"    \n    end\n    \n    return \"灭龙要塞集结中\"\nend",
			["yOffset"] = 0,
			["anchorPoint"] = "CENTER",
			["sparkRotation"] = 0,
			["sparkRotationMode"] = "AUTO",
			...
			["actions"] = {
				...
				["init"] = {
					["custom"] = "aura_env.lastCheck = 0\naura_env.nextFeastIn = 0\naura_env.eventEndAt = 2*60*60\n\naura_env.hasWeeklyCompleted = function()\n    return C_QuestLog.IsQuestFlaggedCompleted(70866)\nend\n\naura_env.disabled = aura_env.config.disableOnCompletion and aura_env.hasWeeklyCompleted()\n\nlocal nextDayMap = {\n    [\"Monday\"] = \"Tuesday\", \n    [\"Tuesday\"] = \"Wednesday\", \n    [\"Wednesday\"] = \"Thursday\", \n    [\"Thursday\"] = \"Friday\",\n    [\"Friday\"] = \"Saturday\", \n    [\"Saturday\"] = \"Sunday\",    \n    [\"Sunday\"] = \"Monday\",\n}\n\nlocal dayMap = {\n    \"Sunday\",\n    \"Monday\",\n    \"Tuesday\",\n    \"Wednesday\",\n    \"Thursday\",\n    \"Friday\",\n    \"Saturday\"\n}\n\nlocal weekdayTimesMap = {\n    [\"Monday\"] = {\n        \"01:00\",\n        \"03:00\",\n        \"05:00\",\n        \"07:00\",\n        \"09:00\",\n        \"11:00\",\n        \"13:00\",\n        \"15:00\",\n        \"17:00\",\n        \"19:00\",\n        \"21:00\",\n        \"23:00\",          \n    },\n    [\"Tuesday\"] = {\n        \"01:00\",\n        \"03:00\",\n        \"05:00\",\n        \"07:00\",\n        \"09:00\",\n        \"11:00\",\n        \"13:00\",\n        \"15:00\",\n        \"17:00\",\n        \"19:00\",\n        \"21:00\",\n        \"23:00\",\n    },\n    [\"Wednesday\"]= {\n        \"01:00\",\n        \"03:00\",\n        \"05:00\",\n        \"07:00\",\n        \"09:00\",\n        \"11:00\",\n        \"13:00\",\n        \"15:00\",\n        \"17:00\",\n        \"19:00\",\n        \"21:00\",\n        \"23:00\",\n    },\n    [\"Thursday\"] = {\n        \"01:00\",\n        \"03:00\",\n        \"05:00\",\n        \"07:00\",\n        \"09:00\",\n        \"11:00\",\n        \"13:00\",\n        \"15:00\",\n        \"17:00\",\n        \"19:00\",\n        \"21:00\",\n        \"23:00\",\n    },\n    [\"Friday\"] = {\n        \"01:00\",\n        \"03:00\",\n        \"05:00\",\n        \"07:00\",\n        \"09:00\",\n        \"11:00\",\n        \"13:00\",\n        \"15:00\",\n        \"17:00\",\n        \"19:00\",\n        \"21:00\",\n        \"23:00\",\n    },\n    [\"Saturday\"] = {\n        \"01:00\",\n        \"03:00\",\n        \"05:00\",\n        \"07:00\",\n        \"09:00\",\n        \"11:00\",\n        \"13:00\",\n        \"15:00\",\n        \"17:00\",\n        \"19:00\",\n        \"21:00\",\n        \"23:00\",\n    },\n    [\"Sunday\"] = {\n        \"01:00\",\n        \"03:00\",\n        \"05:00\",\n        \"07:00\",\n        \"09:00\",\n        \"11:00\",\n        \"13:00\",\n        \"15:00\",\n        \"17:00\",\n        \"19:00\",\n        \"21:00\",\n        \"23:00\",\n    }\n}\n\naura_env.transformIndexToWeekday = function(index)\n    return dayMap[index]    \nend\n\naura_env.getNextDay = function(day)\n    return nextDayMap[day]\nend\n\naura_env.findTimesForDay = function(day)\n    return weekdayTimesMap[day]\nend\n\naura_env.findNextEventForTime = function(times, hours, minutes)\n    for i = 1, #times, 1 do\n        local hour = tonumber(string.sub(times[i], 1, 2))\n        local minute = tonumber(string.sub(times[i], 4, 5))      \n        \n        if hour > hours or (hour == hours and minutes < minute) then\n            return hour, minute \n        end\n    end\nend\n\nlocal function getRemainingSecondsOfDay(hours, minutes)\n    return 86400 - hours * 60 * 60 - minutes * 60\nend\n\naura_env.calcSecondsUntil = function(hours, minutes, eventStartHours, eventStartMinutes)\n    -- eg 22:30 -> 1:30\n    if hours > eventStartHours then               \n        return getRemainingSecondsOfDay(hours, minutes) + eventStartHours * 60 * 60 + eventStartMinutes * 60    \n    end\n    \n    -- eg 22:07 -> 22:30\n    if hours == eventStartHours then        \n        return (eventStartMinutes - minutes) * 60\n    end\n    \n    -- eg 21:07 -> 22:30\n    local hoursDiff = eventStartHours - hours\n    local minutesDiff = eventStartMinutes - minutes\n    \n    return hoursDiff * 60 * 60 + minutesDiff * 60 \nend\n\n\n",
					["do_custom"] = true,
				},
				["finish"] = {
				},
