				...
				["Unholy"] = {
					...
					["lists"] = {
						["opener"] = {
							{
								["enabled"] = true,
								["criteria"] = "buff.commander_of_the_dead_window.up",
								["use_off_gcd"] = 1,
								["description"] = "Opener",
							...
							{
								["enabled"] = true,
								["criteria"] = "pet.gargoyle.active || ! talent.summon_gargoyle.enabled & pet.army_ghoul.active || ! talent.summon_gargoyle.enabled & ! talent.army_of_the_dead.enabled & buff.dark_transformation.up",
								["action"] = "potion",
							}, -- [2]
							{
								["enabled"] = true,
								["criteria"] = "pet.gargoyle.active & ! prev_gcd.1.death_coil",
								["action"] = "death_coil",
							}, -- [3]
							{
								["enabled"] = true,
						...
						["generic"] = {
							{
								["enabled"] = true,
								["criteria"] = "! variable.pooling_runic_power & ( rune < 3 || runic_power.deficit < 20 || pet.gargoyle.active || buff.sudden_doom.react )",
								["action"] = "death_coil",
							}, -- [1]
							{
								["enabled"] = true,
						...
						["cooldowns"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "variable.st_planning & ( talent.commander_of_the_dead.enabled & cooldown.apocalypse.remains < gcd.max || ! talent.commander_of_the_dead.enabled )",
								["action"] = "dark_transformation",
							}, -- [5]
							{
								["enabled"] = true,
								["criteria"] = "variable.adds_remain & ( cooldown.any_dnd.remains < 10 & talent.infected_claws.enabled & ( ( cooldown.vile_contagion.remains || raid_event.adds.exists & raid_event.adds.in > 10 ) & death_knight.fwounded_targets < active_enemies || ! talent.vile_contagion.enabled ) & ( raid_event.adds.remains > 5 || ! raid_event.adds.exists ) || ! talent.infected_claws.enabled ) || boss & fight_remains < 25",
								["action"] = "dark_transformation",
							}, -- [6]
							{
								["enabled"] = true,
								["criteria"] = "active_enemies <= 3 & cooldown.dark_transformation.remains",
								["action"] = "apocalypse",
								["cycle_targets"] = 1,
							}, -- [7]
							{
				...
				["Blood"] = {
					...
					["lists"] = {
						["drw_up"] = {
							{
								["enabled"] = true,
								["criteria"] = "buff.bone_shield.stack > 5 & rune >= 2 & runic_power.deficit >= 30 & ( ( talent.shattering_bone.enabled & death_and_decay.ticking ) || ! talent.shattering_bone.enabled )",
								["action"] = "tombstone",
							}, -- [1]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.bone_shield.stack < 5 & buff.dancing_rune_weapon.remains < gcd.max",
								["action"] = "marrowrend",
							}, -- [3]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "! death_and_decay.ticking & ( spell_targets.death_and_decay = 3 & buff.crimson_scourge.up ) || spell_targets.death_and_decay >= 4",
								["action"] = "death_and_decay",
							}, -- [14]
							{
								["enabled"] = true,
						...
						["standard"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "( runic_power.deficit <= variable.heart_strike_rp ) || boss & fight_remains < 10",
								["action"] = "death_strike",
							}, -- [14]
							{
								["enabled"] = true,
